...
from trainer.trainer_multiintent import Trainer_multi
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cls_token_cat", type=int, default=0,
                        help='whether we cat the cls to the slot output of bert')
    parser.add_argument("--intent_attn", type=int, default=0,
                        help='whether we use attention mechanism on the CLS intent output')
    parser.add_argument("--num_mask", type=int, default=0, help="assumptive number of slot in one sentence")
