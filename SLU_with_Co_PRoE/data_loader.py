...
class JointProcessorMultiIntent(object):
    ...
    def _create_examples(self, texts, intents, slots, intent_tokens, set_type):
        ...
        for i, (text, intent, slot, intent_token) in enumerate(zip(texts, intents, slots, intent_tokens)):
            ...
            intent_label_token = [
                self.intent_labels.index(int_tok) if int_tok in self.intent_labels else self.intent_labels.index('UNK')
            ...
            for s in intent_token.split():
                intent_token_list.append(
                    self.intent_labels.index(s) if s in self.intent_labels else self.intent_labels.index('UNK'))
